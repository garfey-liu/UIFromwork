...
namespace Framework
{
    ...
    public class Console
    {
        ...
        const int margin = 20;
        Rect windowRect = new Rect(margin + Screen.width * 0.5f, margin, Screen.width * 0.5f - (2 * margin), Screen.height - (4 * margin));
        ...
        private Console()
        {
            ...
            //Launch.Instance.onUpdate += Update;
            //Launch.Instance.onGUI += OnGUI;
...
#if UNITY_EDITOR || UNITY_FORM_WIN || UNITY_STANDALONE_WIN
        ...
        void ConsoleWindow(int windowID)
        {
            ...
            for (int i = 0; i < entries.Count; i++)
            {
                ...
                {
                    GUILayout.Label(entry.message + " || " + entry.stackTrace, style);
                }
                else
                {
